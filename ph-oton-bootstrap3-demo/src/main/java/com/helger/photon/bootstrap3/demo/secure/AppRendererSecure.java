 ...
 */
package com.helger.photon.bootstrap3.demo.secure;
...
import com.helger.photon.bootstrap3.demo.app.CApp;
import com.helger.photon.bootstrap3.demo.app.ui.AppCommonUI;
import com.helger.photon.bootstrap3.demo.pub.AppRendererPublic;
...
public final class AppRendererSecure
{
  ...
  private static IHCNode _getNavbar (@NonNull final SimpleWebExecutionContext aSWEC)
  {
    ...
    aNav.addItem (new HCA (LinkHelper.getURLWithContext (aRequestScope, LogoutServlet.SERVLET_DEFAULT_PATH)).addChild (
                                                                                                                       EPhotonCoreText.LOGIN_LOGOUT.getDisplayText (aDisplayLocale)));
